...
class VSFtpSender implements Runnable {
    private GUDPSocket_refer gUdpSocket;
    private ArrayList<InetSocketAddress> destSocketAddresses;
    private String[] fileNames;
    private boolean debug = false;
    
    VSFtpSender(GUDPSocket_refer socket, ArrayList<InetSocketAddress> destinations, String[] files) {
        gUdpSocket = socket;
...
public class VSSend {
    ...
    static GUDPSocket_refer gUdpSocket;
    ...
    public static void main(String[] args) throws IOException {
        ...
        gUdpSocket = new GUDPSocket_refer(dsock);
